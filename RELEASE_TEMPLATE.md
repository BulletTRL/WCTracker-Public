...
Use this template to turn the dev log entries since the last release into a clean, player-facing update.
...
### Prompt to Generate Release Notes

Summarize all DEVLOG entries since the last release into a user-facing update.
Requirements:
- Keep it concise and human-readable (no internal file names or script names).
